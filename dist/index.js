(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("d3"), require("firebase"));
	else if(typeof define === 'function' && define.amd)
		define("Graph", ["d3", "firebase"], factory);
	else if(typeof exports === 'object')
		exports["Graph"] = factory(require("d3"), require("firebase"));
	else
		root["Graph"] = factory(root["d3"], root["firebase"]);
...
var FirebaseKey = function FirebaseKey() {
	return _firebase2.default.database().ref('/').push().key;
};
